    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (AccaptJson != null) {
                ...
                String Sender = AcJson.getString("senduser");
                String Receiver = AcJson.getString("receiveuser");
                String Message = AcJson.getString("message");
                operator.SaveMsg(Sender, Receiver, Message);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
